...
void console_task(struct SHEET *sheet, int memtotal)
{
	...
	cons_putstr0(&cons,"欢迎使用WBoxOS操作系统[Beta 2]!\n\n");
	/* 僾儘儞僾僩昞帵 */
	cons_putchar(&cons, '>', 1);
...
void cons_runcmd(char *cmdline, struct CONSOLE *cons, int *fat, int memtotal)
{
	if (strcmp(cmdline, "mem") == 0 && cons->sht != 0) {
		...
		cons_putstr0(cons," _______     ___     _______   ____     _\n|____   |   /   |   / ______| |    \\   | |\n     / /   /_/| |  | |   ___  | |\\  \\  | |\n    / /       | |  | |  |_    | | \\  \\ | |\n   / /        | |  | |____| | | |  \\  \\| |\n  /_/         |_|  |________| |_|   \\____|    Deep Space\n\n");
		cons_putstr0(cons,"关于WBoxOS Operating System\n");
		cons_putstr0(cons,"WBoxOS Operating System v0.3[Beta 2]\n");
		cons_putstr0(cons,"\n基于HariboteOS操作系统，单内核操作系统\n");
		cons_putstr0(cons,"WRH编写，版权归71GN Deep Space所有\n");
		cons_putstr0(cons,"此系统属于自由软件，你可以使用、编译、再次分发此软件\n");
		cons_putstr0(cons,"\n请尊重71GN Deep Space的所有权利\n");
	} else if (cmdline[0] != 0) {
